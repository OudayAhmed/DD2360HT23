...
int main(int argc, char **argv) {
  ...
  */
  ...
  if (concurrentAccessQ) {
    ...
    cudaMemPrefetchAsync(temp, dimX * sizeof(double), deviceId);
    cudaMemPrefetchAsync(tmp, dimX * sizeof(double), deviceId);
    cudaMemPrefetchAsync(A, dimX * dimX * sizeof(double), deviceId);
  ...
  */
  ...
  // Create the matrix descriptor for cuSPARSE
